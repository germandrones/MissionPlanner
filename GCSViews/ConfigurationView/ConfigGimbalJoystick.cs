...
namespace GCSViews.ConfigurationView.ConfigGimbalJoystick
{
    partial class ConfigGimbal : MyUserControl, IActivate
    {
        ...
        private void Joystick_Load(object sender, EventArgs e)
        {
            try
            {
                var joysticklist = MissionPlanner.CamJoystick.CamJoystick.getDevices();
